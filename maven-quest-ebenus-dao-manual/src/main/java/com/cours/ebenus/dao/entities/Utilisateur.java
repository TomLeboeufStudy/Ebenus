...
public class Utilisateur {
    ...
    public Utilisateur(int i, String test, String nom, Role role, Integer idRole, String identifiant, String description) {
    }
    ...
    public String toString() {
        return String.format("idUtilisateur=%s, " +
                        "civilite=%s, " +
                        "prenom=%s, " +
                        "nom=%s, " +
                        "identifiant=%s, " +
...
/*
    ...
    public boolean equals(Utilisateur user) {
        return this.getIdUtilisateur() == user.getIdUtilisateur();
    }
